...
app_package="fm.ani.articulationserver"
dir_app_name="fm.ani.articulationserver"
...
cd /home/tej/Documents/fmSpin/Ani/ClientApp/Android_Ani/articulationserver/
...
$ADB shell "am start-foreground-service fm.ani.articulationserver/FrameworkInterface.InterfaceImplementation.Services.ArticulationService"
