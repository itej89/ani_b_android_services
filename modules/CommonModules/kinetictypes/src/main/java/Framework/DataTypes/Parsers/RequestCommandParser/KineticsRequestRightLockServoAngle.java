...
public class KineticsRequestRightLockServoAngle extends KineticsRequestForActuator
{
    ...
    protected KineticsRequestRightLockServoAngle(Parcel in) {
        super(in);
    ...
    public static final Creator<KineticsRequestRightLockServoAngle> CREATOR = new Creator<KineticsRequestRightLockServoAngle>() {
        @Override
        public KineticsRequestRightLockServoAngle createFromParcel(Parcel source) {
            return new KineticsRequestRightLockServoAngle(source);
        }

        @Override
        public KineticsRequestRightLockServoAngle[] newArray(int size) {
            return new KineticsRequestRightLockServoAngle[size];
        }
    };
}
