...
public class KineticsRequestISLEEPROMWrite extends KineticsRequest
{
    ...
    protected KineticsRequestISLEEPROMWrite(Parcel in) {
        super(in);
    ...
    public static final Creator<KineticsRequestISLEEPROMWrite> CREATOR = new Creator<KineticsRequestISLEEPROMWrite>() {
        @Override
        public KineticsRequestISLEEPROMWrite createFromParcel(Parcel source) {
            return new KineticsRequestISLEEPROMWrite(source);
        }

        @Override
        public KineticsRequestISLEEPROMWrite[] newArray(int size) {
            return new KineticsRequestISLEEPROMWrite[size];
        }
    };
}
