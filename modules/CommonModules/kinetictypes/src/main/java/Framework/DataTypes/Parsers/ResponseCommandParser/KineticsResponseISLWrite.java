...
public class KineticsResponseISLWrite extends  KineticsResponse
{
    ...
    protected KineticsResponseISLWrite(Parcel in) {
        super(in);
    ...
    public static final Creator<KineticsResponseISLWrite> CREATOR = new Creator<KineticsResponseISLWrite>() {
        @Override
        public KineticsResponseISLWrite createFromParcel(Parcel source) {
            return new KineticsResponseISLWrite(source);
        }

        @Override
        public KineticsResponseISLWrite[] newArray(int size) {
            return new KineticsResponseISLWrite[size];
        }
    };
}
