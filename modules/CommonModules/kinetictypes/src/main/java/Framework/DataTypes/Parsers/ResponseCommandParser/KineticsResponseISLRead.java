...
public class KineticsResponseISLRead extends  KineticsResponse
{
    ...
    protected KineticsResponseISLRead(Parcel in) {
        super(in);
    ...
    public static final Creator<KineticsResponseISLRead> CREATOR = new Creator<KineticsResponseISLRead>() {
        @Override
        public KineticsResponseISLRead createFromParcel(Parcel source) {
            return new KineticsResponseISLRead(source);
        }

        @Override
        public KineticsResponseISLRead[] newArray(int size) {
            return new KineticsResponseISLRead[size];
        }
    };
}
