...
app_package="fm.ani.augmentationservice"
dir_app_name="fm.ani.augmentationservice"
...
cd /home/tej/Documents/fmSpin/Ani/ClientApp/Android_Ani/AugmentationService
...
$ADB shell "am start-foreground-service fm.ani.augmentationservice/fm.ani.augmentationservice.AugmentationService"
