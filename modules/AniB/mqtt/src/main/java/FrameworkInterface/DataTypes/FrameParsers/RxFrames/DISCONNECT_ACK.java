...
public class DISCONNECT_ACK extends RxBaseFrame {

    String ID = "";
    ACK jACK = ACK.NA;

    public DISCONNECT_ACK()
    {
        super();
    }

    public DISCONNECT_ACK(String _ID, ACK _ACK) {
        super();
    ...
    public String Json()
    {
        ...
        try {
            ...
            json.put("ANSTMSG", ANIMSG.DISCONNECT_ACK.toString());
            json.put("ID", ID);
            json.put("ACK", jACK);
