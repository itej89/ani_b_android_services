...
import fm.ani.client.db.DataTypes.Choreogram.Beats_Type;
...
(cursor.getColumnIndex(CommandStore_Table_Columns.MACHINE_POSITIONS_COLUMNS.TURN.toString()));
    ...
    public String  saveBeat(Beats_Type Data) {
    ...
    public  ArrayList<Beats_Type> ReadBeatsByBeatID(String TableName, int BEAT_ID) {

        ArrayList<Beats_Type> Beats = new ArrayList<Beats_Type>();
        ...
        if (cursor.moveToFirst()) {
            do {
                ...
                Beats.add(new Beats_Type(act_Id, beat_id, action_Data, joy, surprise, fear, sadness, anger, disgust, startSec, endSec));
    ...
    public  ArrayList<Beats_Type> ReadBeatsByActID(String TableName, int ACT_ID) {
