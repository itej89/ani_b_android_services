...
public class ISLEEPROMReadJOB extends Job implements KineticsResponseConvey
{
...
//End KineticsResponseConvey delegate
    ...
    public ISLEEPROMReadJOB(EEPROMDetails Details, ISLReadConvey delegate) {
        super();
        ...
        switch(CURRENT_STATE) {
            ...
            case READ_REQUEST: {
                if (KineticComms.Instance.IsConnectedToMachine()) {
                    ...
                    WaitingForKineticsRequestAck = KineticComms.Instance.ReadFromISLEEPROM(ReadDetails.Address, ReadDetails.NoOfBytes);
            ...
            break;
            case EXTRACT_BYTES: {
                DataBytes = KineticComms.Instance.ExtractBytesFromISLEEPROMReadResponse(LastKineticsResponse.get(0));
