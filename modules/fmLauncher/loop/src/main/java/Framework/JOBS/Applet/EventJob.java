...
public class EventJob extends AnimationEngine implements AnimationEngineConvey {
   ...
   public enum Orientaiton {
        PORTRAIT_OnLoad,
        LANDSCAPE_OnLoad
    }

    Orientaiton OnLoadState = Orientaiton.PORTRAIT_OnLoad;


    public EventJob(AppletIntents.Intents _AppletName, Orientaiton _OnLoadState , AppletJobConvey _delegateResponse) {
        super();
        Name = "Event Job";
...
//            }
    ...
    public  void LoadAnimation()
    {
        ...
        requestToDoEventAnimation(OnLoadState);
    }
    ...
    public void requestToDoEventAnimation(Orientaiton EventName) {
