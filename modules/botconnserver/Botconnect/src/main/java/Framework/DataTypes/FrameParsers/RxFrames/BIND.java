...
public class BIND extends RxBaseFrame {
    public String ID = "";
    public Map<LINK_ANCHORS, String> BIND_INFO = new HashMap<>();
    ...
    public BIND(String _ID, Map<LINK_ANCHORS, String> _BIND_INFO) {
        super();
        jANIMSG = ANIMSG.BIND;
        ID = _ID;
    ...
    public void ParseJson(String Json)
    {
        ...
        try {
            ...
            JSONObject jLINK_INFO = jsonDictionary.getJSONObject("BIND_INFO");
            Iterator<String> iter = jLINK_INFO.keys();
            while (iter.hasNext()) {
                String key = iter.next();
                try {
                    String value = jLINK_INFO.getString(key);
                    BIND_INFO.put(LINK_ANCHORS.valueOf(key) , value);
